...
---
title: "Samantha Csik" # if using a built-in template, this title appears under your photo; you may also remove this if you don't want that title text to appear
image: file/path/to/headshot.jpg # a great spot for your professional headshot :) 
...
website:
  ...
  navbar:
    title: false # override printing your website `title` here
