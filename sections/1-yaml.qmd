...
[Turn your landing page (`index.qmd`) into an "[About Page](https://quarto.org/docs/websites/website-about.html)" with a photo]{.slide-title-smallest}
...
[Update your navbar in `_quarto.yml`]{.slide-title-smaller}
...
[Add a page footer in `_quarto.yml`]{.slide-title}
...
[Add a favicon & personal logo in `_quarto.yml`]{.slide-title-smallest}
