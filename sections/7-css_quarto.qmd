...
[We can write our own class selectors]{.slide-title}
...
Let's first create two different classes: one to center text on the page, and another to color text orange. We can add elements to our **Resources** page to test out our new class selectors:
:::
...
<div class="body-text topbr">**{{< fa angle-right >}}** Remember, class selectors take the form `.selector-name {}`</div>
