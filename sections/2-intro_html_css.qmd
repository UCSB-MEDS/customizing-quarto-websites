...
<center><div class="caption-text topbr"><span style="color: #868A8F">**Note:** Some HTML elements have no content (e.g. the `<br>`, or "break" element) -- these are called *empty* elements and do not have an end tag.</span></div></center>
...
<div class="body-text topbr">Class selectors select HTML elements with a specific class attribute. Class selectors are written using a period followed by the selector name, e.g. `.selector`</div>
...
:::
::: {.column width="60%"}
<center><img src="images/class_selector.png" width="600"/></center>
:::
::::
