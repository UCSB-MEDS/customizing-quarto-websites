...
**Note:** Sass has two syntaxes – SCSS syntax (`.scss`), shown above, is the most common. It stands for **S**assy **C**ascading **S**tylesheets {{< fa smile >}}
:::

---

## {#quarto-compiels data-menu-title="Quarto compiles Sass automatically"}
