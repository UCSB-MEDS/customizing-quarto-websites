...
[**0.**]{.teal-text} I'm going to create a new subdirectory called, `DELETE-LATER/`, to save the following few practice files to (you can delete this whole folder afterwards) -- from your repo's root directory, click on the **folder button** in the **Files** pane to add your new subdirectory.
...
::: {.footer}
As the name implies, you can delete the `DELETE-LATER/` subdirectory after the next few exercises. These files will not be incorporated into our website.
:::
...
::: {.center-text}
***Note:** Because we are in our website repo, the resulting file will be rendered as a web page.*
:::
