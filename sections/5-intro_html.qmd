...
[**1.** In the RStudio Terminal, use the `touch` command to create an HTML file (for simplicity, I did this in my project’s root directory), then choose **Open in Editor**.]{.body-text-s}
