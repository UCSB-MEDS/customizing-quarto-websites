...
<div class="body-text topbr">When we render a new Quarto site, it converts all of our markdown into HTML and applies a pre-built default CSS stylesheet (the Bootswatch [Cosmo theme](https://bootswatch.com/cosmo/)).</div>

<div class="body-text bottombr">We can modify the appearance of our website in a number of ways. We'll learn a bit about the following (but know that this is just a starting point!):</div>
