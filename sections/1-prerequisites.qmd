...
<div class="caption-text bottombr">`r fontawesome::fa("angle-right", fill = "#05859B", a11y = "sem")`**Editing the `index.qmd` YAML** -- you can apply a [pre-built template](https://quarto.org/docs/websites/website-about.html#templates) to give you landing page a sleek and professional appearance (we can further modify this later with some CSS).</div>
...
<div class="body-text topbr">In order to make those changes, we need to dive a bit into the world of [HTML](https://html.spec.whatwg.org/), [CSS](https://www.w3.org/Style/CSS/Overview.en.html) and [Sass](https://sass-lang.com/).</div>
