...
[**1.**]{.teal-text} Add a new CSS file named `practice.css` inside your `DELETE-LATER/` folder by clicking on the `DELETE-LATER/` folder in your Explorer menu, then clicking the **New File...** button.
...
[**3.**]{.teal-text} Write some CSS selectors in your `practice.css` file and save. Update your HTML file as necessary (e.g. using class selectors) to apply your styles. Check out your updates by clicking on the **Open in Browser / Viewer** button. Some suggestions:
