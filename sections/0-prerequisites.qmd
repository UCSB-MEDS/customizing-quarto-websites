...
::: {.body-text-s}
To create a branch, first ensure that you're on `main` by typing either `git branch` into the Terminal (either will tell you which branch you're currently on). If you're not on `main`, you can switch by running `git checkout main`.
:::
...
Run `quarto preview` in the Terminal to view changes in near real time – each time you edit and save your work, the preview will update in your browser.
