...
::: incremental
- [**First**]{.teal-text}, add a [pre-built template](https://quarto.org/docs/websites/website-about.html#templates) to `index.qmd`, then fill out as much of the `_quarto.yml` file as you can / want -- this is the easiest way to add some really cool features with minimal effort.
